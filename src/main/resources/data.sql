-- Clear existing data (respecting FK constraints - delete in order)
DELETE FROM enrollment_people;
DELETE FROM claims;
DELETE FROM policy_enrollments;
DELETE FROM policy_plans;
...
-- ============================================
INSERT INTO users (id, full_name, email, password_hash, phone, role, is_active, created_at, updated_at) VALUES
...
-- ============================================
INSERT INTO policy_categories (id, name, description, is_active, created_at) VALUES
...
-- POLICIES
-- ============================================
INSERT INTO policies (id, policy_code, name, policy_type, description, min_age, max_age, waiting_period_days, is_active, category_id, created_by, created_at, updated_at) VALUES
...
INSERT INTO policy_plans (id, plan_name, coverage_amount, premium_amount, premium_basis, tenure_options, max_members, room_rent_limit, renewal_allowed, is_active, policy_id, created_at, updated_at) VALUES
